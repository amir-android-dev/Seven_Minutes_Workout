...
object Constants {
    fun defaultExerciseList():ArrayList<ExerciseModel>{
        ...
        val pushUpAndRotation = ExerciseModel(7,"Push up and Rotation",
        ...
        val stepUpOntoChair = ExerciseModel(10,"Step Up onto Chair",
            R.drawable.ic_step_up_onto_chair,false,false)
        exerciseList.add(stepUpOntoChair)

        val tricepsDipOnChair = ExerciseModel(11,"Triceps Dip On Chair",
