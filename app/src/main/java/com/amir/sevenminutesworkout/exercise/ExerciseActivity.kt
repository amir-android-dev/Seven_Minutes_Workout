...
import com.amir.sevenminutesworkout.*
import com.amir.sevenminutesworkout.databinding.ActivityExerciseBinding
import com.amir.sevenminutesworkout.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
  ...
  //  private var exerciseTimerDuration: Long = 1000
    ...
    private fun dialogComeBackInformation() {
    ...
    private fun setupExerciseStatusRecyclerView() {
        ...
        binding?.rvExercise?.adapter = exerciseStatusAdapter
    }

    private fun setupRestView() {
        try {
            val soundURI =
                Uri.parse("android.resource://com.amir.sevenminutesworkout/" + R.raw.sms_tone)
